...
function injectCss(){
  ...
  style.textContent = `.customerTableShell{position:relative;overflow:hidden}.customerDataScroll{overflow-x:auto;-webkit-overflow-scrolling:touch;overscroll-behavior-x:contain;touch-action:pan-x pan-y;padding-left:0}.bookkeepingDrawerToggle{position:absolute;left:0;top:52px;z-index:4;width:46px;height:30px;border-radius:0 8px 8px 0;border:1px solid rgba(255,255,255,.16);border-left:0;background:rgba(255,255,255,.09);color:var(--text);font-size:18px;line-height:1}.bookkeepingDrawer{position:absolute;left:0;top:0;bottom:0;z-index:3;width:min(260px,76vw);transform:translateX(calc(-100% + 46px));transition:transform .18s ease;background:rgba(10,16,26,.98);border-right:1px solid rgba(255,255,255,.14);box-shadow:14px 0 34px rgba(0,0,0,.28);padding:12px 12px 12px 54px;overflow:auto}.bookkeepingOpen .bookkeepingDrawer{transform:translateX(0)}.bookkeepingOpen .customerDataScroll{padding-left:min(260px,76vw)}.bookkeepingTitle{font-weight:900;margin-bottom:10px}.bookkeepingItem{display:grid;gap:3px;padding:9px 0;border-bottom:1px solid rgba(255,255,255,.1)}.bookkeepingItem span{font-size:12px;color:var(--muted)}@media (max-width:720px){#customersTable.tableCard{overflow:hidden}.customerDataScroll table{min-width:980px}.bookkeepingDrawerToggle{top:48px;width:52px;height:32px}.bookkeepingOpen .customerDataScroll{padding-left:0}.bookkeepingOpen .bookkeepingDrawer{width:min(285px,82vw)}}`;
